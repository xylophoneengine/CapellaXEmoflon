...
public class UserDefined_set_string_to_value_if_not_bound extends RuntimeTGGAttributeConstraint
{

   /**
    * Constraint set_string_to_value_if_not_bound(v0, v1)
    * 
    ...
    */
	...
	public void solve() {
		if (variables.size() != 2)
			throw new RuntimeException("The CSP -SET_STRING_TO_VALUE_IF_NOT_BOUND- needs exactly 2 variables");
