 ...
 * </p>
 * <ul>
 *   <li>{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__SRC__src_abstract_capability_pkg <em>CREATE SRC src abstract capability pkg</em>}</li>
 *   <li>{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__SRC__src_oa_arch <em>CREATE SRC src oa arch</em>}</li>
 *   <li>{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__TRG__trg_ctx_arch <em>CREATE TRG trg ctx arch</em>}</li>
 *   <li>{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__CORR__oa2ctx <em>CREATE CORR oa2ctx</em>}</li>
 * </ul>
 *
...
public interface OperationalAnalysis2SystemAnalysis__Marker extends EObject, TGGRuleApplication {
	 ...
	 * @see Oa2Ctx.Oa2CtxPackage#getOperationalAnalysis2SystemAnalysis__Marker_CREATE__SRC__src_abstract_capability_pkg()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__SRC__src_abstract_capability_pkg <em>CREATE SRC src abstract capability pkg</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Oa2Ctx.Oa2CtxPackage#getOperationalAnalysis2SystemAnalysis__Marker_CREATE__SRC__src_oa_arch()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__SRC__src_oa_arch <em>CREATE SRC src oa arch</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Oa2Ctx.Oa2CtxPackage#getOperationalAnalysis2SystemAnalysis__Marker_CREATE__TRG__trg_ctx_arch()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__TRG__trg_ctx_arch <em>CREATE TRG trg ctx arch</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see Oa2Ctx.Oa2CtxPackage#getOperationalAnalysis2SystemAnalysis__Marker_CREATE__CORR__oa2ctx()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link Oa2Ctx.OperationalAnalysis2SystemAnalysis__Marker#getCREATE__CORR__oa2ctx <em>CREATE CORR oa2ctx</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
