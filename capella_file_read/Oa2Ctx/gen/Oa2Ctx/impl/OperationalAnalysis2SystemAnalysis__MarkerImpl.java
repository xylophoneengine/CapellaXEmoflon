 ...
 * </p>
 * <ul>
 *   <li>{@link Oa2Ctx.impl.OperationalAnalysis2SystemAnalysis__MarkerImpl#getCREATE__SRC__src_abstract_capability_pkg <em>CREATE SRC src abstract capability pkg</em>}</li>
 *   <li>{@link Oa2Ctx.impl.OperationalAnalysis2SystemAnalysis__MarkerImpl#getCREATE__SRC__src_oa_arch <em>CREATE SRC src oa arch</em>}</li>
 *   <li>{@link Oa2Ctx.impl.OperationalAnalysis2SystemAnalysis__MarkerImpl#getCREATE__TRG__trg_ctx_arch <em>CREATE TRG trg ctx arch</em>}</li>
 *   <li>{@link Oa2Ctx.impl.OperationalAnalysis2SystemAnalysis__MarkerImpl#getCREATE__CORR__oa2ctx <em>CREATE CORR oa2ctx</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationalAnalysis2SystemAnalysis__MarkerImpl extends TGGRuleApplicationImpl implements OperationalAnalysis2SystemAnalysis__Marker {
		...
		if (creatE__SRC__src_abstract_capability_pkg != null && creatE__SRC__src_abstract_capability_pkg.eIsProxy()) {
			...
			if (creatE__SRC__src_abstract_capability_pkg != oldCREATE__SRC__src_abstract_capability_pkg) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_ABSTRACT_CAPABILITY_PKG, oldCREATE__SRC__src_abstract_capability_pkg, creatE__SRC__src_abstract_capability_pkg));
			}
		}
	...
	public void setCREATE__SRC__src_abstract_capability_pkg(OperationalCapabilityPkg newCREATE__SRC__src_abstract_capability_pkg) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_ABSTRACT_CAPABILITY_PKG, oldCREATE__SRC__src_abstract_capability_pkg, creatE__SRC__src_abstract_capability_pkg));
	}
	...
	public OperationalAnalysis getCREATE__SRC__src_oa_arch() {
		if (creatE__SRC__src_oa_arch != null && creatE__SRC__src_oa_arch.eIsProxy()) {
			...
			if (creatE__SRC__src_oa_arch != oldCREATE__SRC__src_oa_arch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_OA_ARCH, oldCREATE__SRC__src_oa_arch, creatE__SRC__src_oa_arch));
			}
		}
	...
	public void setCREATE__SRC__src_oa_arch(OperationalAnalysis newCREATE__SRC__src_oa_arch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_OA_ARCH, oldCREATE__SRC__src_oa_arch, creatE__SRC__src_oa_arch));
	}
	...
	public SystemAnalysis getCREATE__TRG__trg_ctx_arch() {
		if (creatE__TRG__trg_ctx_arch != null && creatE__TRG__trg_ctx_arch.eIsProxy()) {
			...
			if (creatE__TRG__trg_ctx_arch != oldCREATE__TRG__trg_ctx_arch) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_TRG_TRG_CTX_ARCH, oldCREATE__TRG__trg_ctx_arch, creatE__TRG__trg_ctx_arch));
			}
		}
	...
	public void setCREATE__TRG__trg_ctx_arch(SystemAnalysis newCREATE__TRG__trg_ctx_arch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_TRG_TRG_CTX_ARCH, oldCREATE__TRG__trg_ctx_arch, creatE__TRG__trg_ctx_arch));
	}
	...
	public OperationalAnalysis2SystemAnalysis getCREATE__CORR__oa2ctx() {
		if (creatE__CORR__oa2ctx != null && creatE__CORR__oa2ctx.eIsProxy()) {
			...
			if (creatE__CORR__oa2ctx != oldCREATE__CORR__oa2ctx) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_CORR_OA2CTX, oldCREATE__CORR__oa2ctx, creatE__CORR__oa2ctx));
			}
		}
	...
	public void setCREATE__CORR__oa2ctx(OperationalAnalysis2SystemAnalysis newCREATE__CORR__oa2ctx) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_CORR_OA2CTX, oldCREATE__CORR__oa2ctx, creatE__CORR__oa2ctx));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_ABSTRACT_CAPABILITY_PKG:
				if (resolve) return getCREATE__SRC__src_abstract_capability_pkg();
				return basicGetCREATE__SRC__src_abstract_capability_pkg();
			case Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_SRC_SRC_OA_ARCH:
				if (resolve) return getCREATE__SRC__src_oa_arch();
				return basicGetCREATE__SRC__src_oa_arch();
			case Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_TRG_TRG_CTX_ARCH:
				if (resolve) return getCREATE__TRG__trg_ctx_arch();
				return basicGetCREATE__TRG__trg_ctx_arch();
			case Oa2CtxPackage.OPERATIONAL_ANALYSIS2_SYSTEM_ANALYSIS_MARKER__CREATE_CORR_OA2CTX:
