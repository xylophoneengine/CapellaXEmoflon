 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalLinkEndImpl#getInvolvedLinks <em>Involved Links</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractPhysicalLinkEndImpl extends ModelElementImpl implements AbstractPhysicalLinkEnd {
	...
	public EList<AbstractPropertyValue> getOwnedPropertyValues() {
		...
		if (ownedPropertyValues == null) {
			ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class, this, CsPackage.ABSTRACT_PHYSICAL_LINK_END__OWNED_PROPERTY_VALUES);
		}
	...
	public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
		...
		if (ownedEnumerationPropertyTypes == null) {
			ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(EnumerationPropertyType.class, this, CsPackage.ABSTRACT_PHYSICAL_LINK_END__OWNED_ENUMERATION_PROPERTY_TYPES);
		}
	...
	public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
		...
		if (ownedPropertyValueGroups == null) {
			ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class, this, CsPackage.ABSTRACT_PHYSICAL_LINK_END__OWNED_PROPERTY_VALUE_GROUPS);
		}
