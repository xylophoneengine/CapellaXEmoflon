 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getIncomingTraces <em>Incoming Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getOutgoingTraces <em>Outgoing Traces</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#isVisibleInDoc <em>Visible In Doc</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#isVisibleInLM <em>Visible In LM</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getSummary <em>Summary</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getReview <em>Review</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getOwnedPropertyValues <em>Owned Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getOwnedEnumerationPropertyTypes <em>Owned Enumeration Property Types</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getAppliedPropertyValues <em>Applied Property Values</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getOwnedPropertyValueGroups <em>Owned Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getAppliedPropertyValueGroups <em>Applied Property Value Groups</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getFeatures <em>Features</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getAppliedRequirements <em>Applied Requirements</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.cs.impl.AbstractPhysicalArtifactImpl#getAllocatorConfigurationItems <em>Allocator Configuration Items</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractPhysicalArtifactImpl extends ModelElementImpl implements AbstractPhysicalArtifact {
	...
	public EList<AbstractPropertyValue> getOwnedPropertyValues() {
		...
		if (ownedPropertyValues == null) {
			ownedPropertyValues = new EObjectContainmentEList.Resolving<AbstractPropertyValue>(AbstractPropertyValue.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__OWNED_PROPERTY_VALUES);
		}
	...
	public EList<EnumerationPropertyType> getOwnedEnumerationPropertyTypes() {
		...
		if (ownedEnumerationPropertyTypes == null) {
			ownedEnumerationPropertyTypes = new EObjectContainmentEList.Resolving<EnumerationPropertyType>(EnumerationPropertyType.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__OWNED_ENUMERATION_PROPERTY_TYPES);
		}
	...
	public EList<PropertyValueGroup> getOwnedPropertyValueGroups() {
		...
		if (ownedPropertyValueGroups == null) {
			ownedPropertyValueGroups = new EObjectContainmentEList.Resolving<PropertyValueGroup>(PropertyValueGroup.class, this, CsPackage.ABSTRACT_PHYSICAL_ARTIFACT__OWNED_PROPERTY_VALUE_GROUPS);
		}
