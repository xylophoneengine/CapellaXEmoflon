 ...
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getInStructuredNode <em>In Structured Node</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getIncoming <em>Incoming</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#isIsControlType <em>Is Control Type</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getKindOfNode <em>Kind Of Node</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getOrdering <em>Ordering</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getUpperBound <em>Upper Bound</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getInState <em>In State</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#getSelection <em>Selection</em>}</li>
 *   <li>{@link org.polarsys.capella.core.data.fa.impl.FunctionOutputPortImpl#isIsControl <em>Is Control</em>}</li>
