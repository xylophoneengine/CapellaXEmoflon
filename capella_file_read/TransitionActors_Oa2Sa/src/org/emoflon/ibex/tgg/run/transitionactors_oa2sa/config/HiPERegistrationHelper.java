package org.emoflon.ibex.tgg.run.transitionactors_oa2sa.config;
...
import org.emoflon.ibex.tgg.operational.csp.constraints.factories.transitionactors_oa2sa.UserDefinedRuntimeTGGAttrConstraintFactory;
...
import TransitionActors_Oa2Sa.impl.TransitionActors_Oa2SaPackageImpl;
...
//		init_Epackages(rs, executable);
		...
		if(oa2ctxPack == null) {
			oa2ctxPack = TransitionActors_Oa2SaPackageImpl.init();
			rs.getPackageRegistry().put("platform:/resource/Oa2Ctx/model/TransitionActors_Oa2Sa.ecore", TransitionActors_Oa2SaPackage.eINSTANCE);
			rs.getPackageRegistry().put("platform:/plugin/Oa2Ctx/model/TransitionActors_Oa2Sa.ecore", TransitionActors_Oa2SaPackage.eINSTANCE);
		}
...
//		test2.load(null);
	...
	public IbexOptions createIbexOptions() {
		...
		options.project.name("TransitionActors_Oa2Sa");
		options.project.path("TransitionActors_Oa2Sa");
